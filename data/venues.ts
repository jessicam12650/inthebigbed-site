...
export const VENUES: Venue[] = [
  ...
  { id: "slug-lettuce", name: "Slug and Lettuce", cat: ["pub", "bar"], location: { address: "City Centre, Liverpool", latLng: [53.4072, -2.9857] } },
  { id: "refinery", name: "The Refinery Liverpool", cat: ["restaurant"], location: { address: "City Centre, Liverpool", latLng: [53.405, -2.9887] } },
  { id: "club-house", name: "The Club House", cat: ["bar", "restaurant"], location: { address: "City Centre, Liverpool", latLng: [53.4055, -2.9882] } },
  ...
  { id: "brasco-dock", name: "Brasco Lounge", cat: ["bar", "restaurant"], location: { address: "Royal Albert Dock, Liverpool", latLng: [53.4001, -2.9963] } },
  ...
  { id: "pen-factory", name: "The Pen Factory", cat: ["bar", "restaurant"], location: { address: "Hope St, Liverpool", latLng: [53.4016, -2.9689] } },
  ...
  { id: "white-hart", name: "White Hart", cat: ["pub", "bar"], location: { address: "23 Hope Street, Liverpool", latLng: [53.4022, -2.9688] } },
  { id: "queen-hope", name: "Queen of Hope Street", cat: ["pub", "bar"], location: { address: "1-1A Myrtle Street, Liverpool", latLng: [53.4028, -2.9672] } },
  ...
  { id: "frederiks", name: "Frederiks", cat: ["bar", "restaurant"], location: { address: "Hope Street, Liverpool", latLng: [53.4021, -2.9695] } },
  ...
  { id: "brasco-mann", name: "Brasco Lounge", cat: ["bar", "restaurant"], location: { address: "Mann Island, Liverpool", latLng: [53.4037, -2.9978] } },
  ...
  { id: "alberts-schloss", name: "Albert's Schloss", cat: ["bar", "restaurant"], location: { address: "Bold Street, Liverpool", latLng: [0, 0] } },
  { id: "schillers-hall", name: "Schiller's Hall", cat: ["bar", "restaurant"], location: { address: "Hanover Street, Liverpool", latLng: [0, 0] } },
